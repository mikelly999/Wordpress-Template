...
// function enqueue_child_theme_editor_styles() {
//     add_editor_style( get_stylesheet_directory_uri() . '/custom.css' ); // Replace with your CSS file path
// }
// add_action( 'after_setup_theme', 'enqueue_child_theme_editor_styles' );